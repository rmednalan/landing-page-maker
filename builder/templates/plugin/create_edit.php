...
<div class="wrap upfront_admin upfront-builder">
	...
	<h1>
		<?php esc_html_e('JWPB Builder', UpfrontThemeExporter::DOMAIN); ?>
	</h1>
	<p class="info">
		<?php esc_html_e('Create a unique, responsive JWPB theme that you can export, share, sell or tweak to your heart’s content.', UpfrontThemeExporter::DOMAIN); ?>
	</p>
