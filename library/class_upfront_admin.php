...
class Upfront_Admin
{
	...
	public static $menu_slugs = array(
		"main" => "jwpb",
		"restrictions" => "jwpb_restrictions",
		"experimental" => "jwpb_experimental"
	);
	...
	function add_menus(){
		...
		if (Upfront_Permissions::current( Upfront_Permissions::SEE_USE_DEBUG ) || Upfront_Permissions::current( Upfront_Permissions::MODIFY_RESTRICTIONS )) {
			add_menu_page( __("General Settings", Upfront::TextDomain), __("JWPB", Upfront::TextDomain), "manage_options", self::$menu_slugs['main'], null, "dashicons-schedule", 58);
		}
