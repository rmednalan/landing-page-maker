...
class Upfront_Admin_Restrictions extends Upfront_Admin_Page {
	...
	?>
		<div class="wrap upfront_admin upfront_admin_restrictions">
			<h1><?php esc_html_e("User Restrictions", Upfront::TextDomain); ?></h1>
			<form action="<?php echo esc_url( add_query_arg( array("page" => "jwpb_restrictions") ) ) ?>" method="post" id="upfront_restrictions_form">
