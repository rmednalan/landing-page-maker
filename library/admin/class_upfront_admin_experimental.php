...
class Upfront_Admin_Experimental extends Upfront_Admin_Page {
	...
	public function __construct () {
		if ($this->_can_access( Upfront_Permissions::SEE_USE_DEBUG )) {
			add_submenu_page( "jwpb", __("Experimental Features", Upfront::TextDomain), __("Experimental", Upfront::TextDomain), 'manage_options', Upfront_Admin::$menu_slugs['experimental'], array($this, "render_page") );
		}
	}
	...
	public function render_page () {
		...
		<div class="wrap upfront_admin upfront_admin_experimental">
			<h1><?php _e("Experimental Features", Upfront::TextDomain); ?></h1>
						<div class="upfront_admin_experimental_contents">
								<p class="info">
									<?php esc_html_e("These are various Experimental Features available to JWPB. Please be careful, some of those settings might interfere with plugins.", Upfront::TextDomain ); ?>
								</p>
								<form action="<?php echo esc_url( add_query_arg( array("page" => "jwpb_experimental") ) ) ?>" method="post" id="upfront_experimental_form">
												...
												<div class="form_content_group">
														...
														<div class="form_content_input compress_response">
																...
																<div class="upfront_toggle_description">
																	<span class="upfront_toggle_checkbox_main_label"><?php esc_html_e("Enable JWPB Compress Response", Upfront::TextDomain ); ?></span>
																	<span class="upfront_toggle_checkbox_sub_label"><?php esc_html_e("Applies GZip compression to all JWPB-generated responses (AJAX)", Upfront::TextDomain ); ?></span>
																</div>
														</div>
												</div>
										</div>
