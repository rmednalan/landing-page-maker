...
class Upfront_Permissions {
	...
	public function get_capability_labels () {
		...
		return apply_filters('upfront-access-permissions-labels', array(
			...
			self::BOOT => __('Can Access JWPB Editor Mode', Upfront::TextDomain ),
			self::LAYOUT_MODE => __('Can Modify JWPB Layouts', Upfront::TextDomain ),
			...
			self::CREATE_POST_PAGE => __('Can Create Posts & Pages From JWPB', Upfront::TextDomain ),
