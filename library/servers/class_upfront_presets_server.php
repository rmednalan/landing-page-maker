...
abstract class Upfront_Presets_Server extends Upfront_Server {
	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'convert_preset_info' => __('JWPB introduces presets, which allow you to save and re-use styling for any element across your website. Before you can edit this element, choose one of the following options:', 'upfront'),
