	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			'application' => array(
				...
				'long_loading_notice' => __('The JWPB editor may take a while to load (especially first time), please hang in there :)', 'upfront'),
			...
			'views' => array(
				'close_upfront' => __('Close JWPB', 'upfront'),
				...
				'exiting_upfront' => __('Exiting jwpb...', 'upfront'),
