...
$main->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'content' => '<h1 style="text-align: center;">Welcome to JWPB</h1>',
    'type' => 'PlainTxtModel',
...
$main->add_element("PlainTxt", array (
  ...
  'options' =>
  array (
    'content' => '<p style="text-align: center;">Start from scratch with the <a href="' . esc_url(admin_url('admin.php?page=jwpb-builder')) . '">JWPB Builder</a> and bring the site you’ve always dreamed of to life.</p>',
    'type' => 'PlainTxtModel',
    'view_class' => 'PlainTxtView',
